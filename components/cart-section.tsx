  ...
  return (
    <section id="cart" className="py-8">
      ...
      <div className="bg-white rounded-xl border border-gray-100 p-4">
        ...
        <Link
          href={`/catalog/${token}/checkout`}
          className="block w-full py-3 bg-orange-500 text-white font-bold rounded-xl text-center hover:bg-orange-600 transition-colors"
        >
          Ir a pagar →
        </Link>
      </div>
